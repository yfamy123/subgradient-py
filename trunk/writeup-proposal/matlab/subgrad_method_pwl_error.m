...
[x,histo] = sgm_pwl_sqrsum_nonsum(A,b,x_1,1,MAX_ITERS); 
...
if( PRINT_PLOTS ), print -depsc pwl_error_fbest_realize, end
...
if( PRINT_PLOTS ), print -depsc pwl_error_fbest_average, end
...
set(gca,'Xscale','log','FontSize',16), axis([common_axis])
title('iter 5000')
if( PRINT_PLOTS ), print -depsc pwl_error_fbest_dist, end
